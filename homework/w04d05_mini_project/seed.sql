...
INSERT INTO review (title , body , img) VALUES ('BoS (Bachata on Saturday) Review' , 'The night was quite good, I shall break it down into three ratings: music: 7 dance-level: 7 vibe: 8 Pleasant experience with a good range of music, some salsa and zouk as well as bachata. would like a bit less bachata to mix it up a bit, also some merengue would be nice but overall a decent night out and I recommend it 8/10' , '/assets/bg_white.jpg');
